...
class SavedPostsBinding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut(() => GetSavedPostsUseCase(Get.find<NewsFeedRepositoryImpl>()));
    ...
    Get.lazyPut(() => SavedPostsController(Get.find(), Get.find(), Get.find(), Get.find(), Get.find(), Get.find(), Get.find()));
  }
}