...
class ShowPageBinding extends Bindings {
  @override
  void dependencies() {
    ...
    Get.lazyPut(() => PageConnectUseCase(Get.find<SocialRepositoryImpl>()));
    Get.lazyPut(() => ContactSchoolUseCase(Get.find<NewsFeedRepositoryImpl>()));
    ...
    Get.lazyPut(() => CreateReviewUseCase(Get.find<NewsFeedRepositoryImpl>()));
    Get.lazyPut(() => ShowPageController(Get.find(), Get.find(), Get.find(), Get.find(), Get.find(), Get.find(), Get.find(), Get.find(), Get.find(), Get.find(), Get.find()));
  }
}