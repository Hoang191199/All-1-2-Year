...
class NewsFeedSearchSchoolPage extends StatelessWidget {
  NewsFeedSearchSchoolPage({super.key});
        ...
        ? Column(
          ...
          children: [
            ...
            ListView.separated(
              ...
              itemCount: newsFeedSearchController.searchPageData.length,
              itemBuilder: (context, index) {
                final page = newsFeedSearchController.searchPageData[index];
