...
class NewsFeedSearchDetailGroupPage extends StatelessWidget {
  NewsFeedSearchDetailGroupPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetX(
      ...
      initState: (state) async {
        newsFeedSearchController.searchDetailNewsFeed(newsFeedSearchController.searchTextEditingController.text, TypeSearchDetail.groups, null);
                        ...
                        children: [
                          ...
                          ListView.separated(
                            ...
                            itemCount: newsFeedSearchController.isLoadMore.value 
                              ? newsFeedSearchController.searchDetailGroupData.length + 1 
                              : newsFeedSearchController.searchDetailGroupData.length,
                            itemBuilder: (context, index) {
                              if (index < newsFeedSearchController.searchDetailGroupData.length) {
                                final group = newsFeedSearchController.searchDetailGroupData[index];
  ...
  void scrollListener() {
    if (newsFeedSearchController.canLoadMore.value) {
      if (scrollController.position.pixels == scrollController.position.maxScrollExtent) {
        newsFeedSearchController.searchDetailNewsFeedMore(newsFeedSearchController.searchTextEditingController.text, TypeSearchDetail.groups, null);
      }
    }
  }
}