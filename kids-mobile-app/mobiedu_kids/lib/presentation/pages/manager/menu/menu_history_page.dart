...
import 'package:mobiedu_kids/presentation/pages/manager/menu/menu_detail_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GetX(
      ...
      initState: (state) async {
        await checkbox.menuController.history(0, store.getGroupname);
      },
            ...
            Padding(
              ...
              child: ListView.separated(
                ...
                return GestureDetector(
                  onTap: () {
                    Get.to(() => MenuDetailsPage(menu_id: checkbox.menuController.historyMenu[index].menu_id,));
                  },
                  child: Row(
