...
class MenuDetailsChildPage extends StatelessWidget {
  MenuDetailsChildPage({super.key, this.menu_id});
    ...
    return WillPopScope(
      ...
      child: GetX(
        ...
        initState: (state) async {
          await checkbox.menuController.detailChild(store.getChild?.child_id ?? "",menu_id ?? "");
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          Text(
                                            items[checkbox.menuController.indexDateDetail.value],
                                            style: GoogleFonts.raleway(
                                              textStyle: TextStyle(
                                                color: AppColors.primary,
                                                fontWeight:FontWeight.w700,
