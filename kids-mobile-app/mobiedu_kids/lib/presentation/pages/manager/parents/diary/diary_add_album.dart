...
class DiaryAddAlbumChild extends StatelessWidget {
  DiaryAddAlbumChild({super.key, this.child_parent_id});
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            DateFormat('dd/MM/yyyy').format(albumController.indexDate.value),
                                              ...
                                              onPressed: () async {
                                                ...
                                                if (imageAlbumController.listfile.isNotEmpty) {
                                                  for (var i = 0; i < imageAlbumController.listfile.length; i++) {
                                                    albumController.listPhoto.add(ImageMetaData(
                      ...
                      SizedBox(
                        ...
                        child: CupertinoButton(
                          onPressed: albumController.submit.value ? null : () async { 
                            ...
                            await albumController.addAlbumChild(
                              child_parent_id ??"",
                              albumController.caption.text,
                              list,
                              list.length
            ...
            Expanded(
              child: CupertinoDatePicker(
                ...
                onDateTimeChanged: (DateTime newDateTime) async {
                  albumController.indexDate.value = newDateTime;
                },
                initialDateTime: albumController.indexDate.value,
                minimumYear: 1990,
