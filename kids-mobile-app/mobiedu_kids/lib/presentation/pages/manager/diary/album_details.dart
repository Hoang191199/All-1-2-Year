    ...
    return WillPopScope(
      ...
      child: GetX(
        ...
        initState: (state) async {
          await albumController.detail(store.getGroupname, album_id ?? "");
        },
                            ...
                            SimpleDialogOption(
                              onPressed: () {
                                showModalBottomSheet(
                                  ...
                                  context: context,
                                  builder: ((builder) => 
                                  GetBuilder<ImageAlbumController>(
                                    builder: (
                                      (_) => 
                                                  ...
                                                  TextButton.icon(
                                                    ...
                                                    onPressed: () async {
                                                      ...
                                                      if (imageAlbumController.listfile.isNotEmpty) {
                                                        ...
                                                        await albumController.addPhoto(
                                                          store.getGroupname,
                                                          child_id ?? "",
                                                          album_id ?? "",
                                                          lf,
                    ...
                    Expanded(
                      child: GridView.count(
                        ...
                        children: List.generate(
                          albumController.detailAlbum.value?.pictures?.length ?? 0, (ind) {
                                    ...
                                    Expanded(
                                      child: Stack(
                                        ...
                                        children: [
                                          ...
                                          GestureDetector(
                                            onTap: () async {
                                              await albumController.deletePhoto(
                                                store.getGroupname,
                                                child_id ?? "",
    ...
    showCupertinoModalPopup<void>(
      ...
      builder: (BuildContext context) => CupertinoAlertDialog(
        ...
        actions: <CupertinoDialogAction>[
          ...
          CupertinoDialogAction(
            onPressed: () async {
              await albumController.delete(store.getGroupname, child_id ?? "", album_id ?? "");
              Navigator.pop(context);
              Navigator.pop(context);
              await albumController.fetch(
                store.getGroupname,
      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            TextButton(
              onPressed: () async {
                await albumController.editCaption(
                  store.getGroupname,
                  child_id ?? "",
                  album_id ?? "",
