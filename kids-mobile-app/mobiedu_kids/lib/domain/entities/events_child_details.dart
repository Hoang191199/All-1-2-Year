import 'package:mobiedu_kids/domain/entities/participant_cp.dart';

class EventsChildDetails {
  EventsChildDetails(
      {this.event_id,
      this.event_name,
      this.must_register,
  ...
  int? can_register;
  ParticipantCP? participants;

  factory EventsChildDetails.fromJson(Map<String, dynamic>? json) {
    return EventsChildDetails(
      ...
      for_teacher:
          json?["for_teacher"] == null ? null : json?['for_teacher'] as String,
      for_parent:
      ...
      is_notified:
          json?["is_notified"] == null ? null : json?['is_notified'] as String,
      description:
      ...
      participants: json?["participants"] == null
          ? null
          : ParticipantCP.fromJson(json?['participants']),
    );
  }
