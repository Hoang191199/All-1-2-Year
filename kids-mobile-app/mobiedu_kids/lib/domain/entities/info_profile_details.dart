class InfoProfileDetails {
  ...
  factory InfoProfileDetails.fromJson(Map<String, dynamic>? json) {
    return InfoProfileDetails(
      ...
      friends_count:
          json?['friends_count'] == null ? null : json?['friends_count'] as int,
    );
  }
