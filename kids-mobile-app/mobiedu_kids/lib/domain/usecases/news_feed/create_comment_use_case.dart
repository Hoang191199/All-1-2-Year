...
class CreateCommentUseCase extends ParamUseCase<ResponseNoData, Tuple4<String, String, String, Uint8List>> {
  CreateCommentUseCase(this.newsFeedRepository);

  final NewsFeedRepository newsFeedRepository;

  @override
  Future<ResponseNoData> execute(Tuple4 params) {
    return newsFeedRepository.createComment(params.value1, params.value2, params.value3, params.value4);
  }
}