...
import 'package:mooc_app/presentation/pages/profile/roadmap/setting/roadmap_setting_2.dart';
import 'package:mooc_app/presentation/pages/profile/roadmap/setting/step_progress.dart';

import '../../../../widgets/course_item_2.dart';

class RoadmapSetting extends StatelessWidget {
  // static String routeName = "/search";
  RoadmapSetting({super.key,required this.step,required this.title});
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      ElevatedButton(
                                          ...
                                          //   minimumSize: Size.fromHeight(10),
                                          // ),
                                          onPressed: () { Get.to(() => RoadmapSetting2(step: 2,title: ["", "Bước 2/3", ""])); },
                                          child: Container(
                                              margin: EdgeInsets.only(
                                                  left: 5, right: 5),
                                              child: FittedBox(
